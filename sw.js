'use strict';
const CACHE_VERSION='wellone-orders-v98-detail-pages';
const SHELL_CACHE=`${CACHE_VERSION}-shell`;
const RUNTIME_CACHE=`${CACHE_VERSION}-runtime`;
const SHELL_ASSETS=[
  './','./index.html','./css/orders.css?v=98','./js/admin-config.js?v=98','./js/orders-receiving.js?v=98','./js/pwa-install.js?v=98',
