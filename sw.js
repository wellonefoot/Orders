'use strict';
const CACHE_VERSION='wellone-orders-v88-20page-live';
const STATIC_CACHE=`${CACHE_VERSION}-static`;
const IMAGE_CACHE=`${CACHE_VERSION}-images`;
const STATIC_FILES=['./css/orders.css?v=88', './js/receiver.bundle.js?v=88', './js/pwa-install.js?v=88', './manifest.webmanifest', './assets/logo.png?v=88'];
